...
const slides = [
  ...
  {{ src: '/images/foto.png',     srcMobile: null, alt: 'Linha de produção' }},
  {{ src: '/images/foto_2.png',   srcMobile: null, alt: 'Embalagem biscoito' }},
  {{ src: '/images/foto_3.png',   srcMobile: null, alt: 'Fábrica Biscoito Mineiro' }},
  {{ src: '/images/IMG_2372.JPG', srcMobile: null, alt: 'Fornos industriais' }},
  {{ src: '/images/IMG_2379.JPG', srcMobile: null, alt: 'Interior fábrica' }},
]
